...
- (void)drawRect:(CGRect)rect {
    ...
    defaultSpacing = [self configureAVWidth];
    defaultHeight = [self configureAVHeight] + _titleOffset + _bottomOffset;
    ...
    if (_numberOfButtons == 0) { // View only contains DONE/DISMISS Button
        ...
        doneButton.frame = CGRectMake(0,
                                      alertViewFrame.size.height - 45 - _bottomOffset,
                                      alertViewFrame.size.width,
                                      45);
        if (_detachButtons) {
            doneButton.frame = CGRectMake(8,
                                          alertViewFrame.size.height - 50 - _bottomOffset,
        ...
        if (_detachButtons) {
            doneButton.frame = CGRectMake(alertViewFrame.size.width/2 + 2,
                                          doneButton.frame.origin.y - 5 - _bottomOffset,
